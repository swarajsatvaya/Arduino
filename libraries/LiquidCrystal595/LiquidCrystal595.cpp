...
void LiquidCrystal595::clearLine(int num){
...
void LiquidCrystal595::setBacklightOn()
{
	setLED1Pin(HIGH);
	setRSPin(LOW);
	setEPin(LOW);
...
void LiquidCrystal595::setBacklightOff()
{
	setLED1Pin(LOW);
	setRSPin(LOW);
	setEPin(LOW);
...
void LiquidCrystal595::digitalOut(uint8_t pinValue)
{
	if (pinValue == HIGH)
	{
		setLED2Pin(HIGH);
